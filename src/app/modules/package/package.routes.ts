...
router
     .route('/')
     .post(fileUploadHandler(), auth(USER_ROLES.SUPER_ADMIN, USER_ROLES.ADMIN), validateRequest(PackageValidation.createPackageZodSchema), PackageController.createPackage)
